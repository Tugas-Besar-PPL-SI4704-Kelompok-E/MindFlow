    ...
    <style>
        * { font-family: 'Poppins', sans-serif; }
        ...
        @keyframes neonWarningPulse {
            ...
            50% {
                box-shadow: 0 0 3px rgba(220, 38, 38, 0.3), inset 0 0 2px rgba(220, 38, 38, 0.1);
                border-color: rgba(220, 38, 38, 0.5);
                text-shadow: none;
            }
        }
        .badge-neon-warning {
            animation: neonWarningPulse 1s infinite ease-in-out;
            ...
            <nav class="flex-1 overflow-y-auto py-6 flex flex-col">
                ...
                <ul class="flex flex-col gap-1">
                    ...
                    <li><a href="{{ route('forum.index') }}" class="sidebar-link">
                        ...
                        Forum MindFlow</a></li>
                    <li><a href="{{ route('artikel.index') }}" class="sidebar-link">
