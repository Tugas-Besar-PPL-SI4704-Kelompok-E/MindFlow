    ...
    <aside class="w-[280px] bg-white border-r border-gray-200 flex-shrink-0 flex flex-col hidden md:flex sticky top-0 h-screen z-10 pt-4">
        ...
        <div class="flex-grow">
            ...
            <nav class="flex flex-col space-y-1">
                ...
                <div class="pt-6 pb-2">
                    <h2 class="text-[14px] font-extrabold text-[#9CA3AF] px-8 mb-2 uppercase tracking-wider">Account</h2>
                </div>
                ...
                <form method="POST" action="{{ route('logout') }}" class="w-full">
                    ...
                    <button type="submit" class="sidebar-link w-full text-left text-rose-600 hover:bg-rose-50 hover:text-rose-700">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="text-rose-500"><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
                        Log out
                    </button>
                </form>
            </nav>
