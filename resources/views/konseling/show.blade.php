            ...
            <div class="bg-white rounded-[24px] p-6 shadow-sm border border-[#E9D5FF] relative overflow-hidden">
                ...
                <form action="{{ route('booking.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="jadwal" id="jadwal-picker" class="w-full border border-gray-300 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#A881C2] focus:border-[#A881C2] text-sm text-gray-700 shadow-sm transition-shadow bg-white" placeholder="Pilih tanggal dan waktu" required readonly>
                    </div>
